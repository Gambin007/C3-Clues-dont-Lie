  ...
  const teamMembers = [
    {
      ...
      image: '/media/Team/Thalia normal.jpg',
      hoverImage: '/media/Team/Thalia Lupe.jpg',
      hoverColor: '#00c4ff',
    },
    {
      name: 'Philippe',
      role: 'Lead UX/UI Design',
      image: '/media/Team/Philippe normal.jpg',
      hoverImage: '/media/Team/Philippe Lupe.jpg',
      hoverColor: '#fe4a2c',
    },
    {
      name: 'Larissa',
      role: 'Lead Story',
      image: '/media/Team/Larissa normal.jpg',
      hoverImage: '/media/Team/Larissa Lupe.jpg',
      hoverColor: '#ffc32e',
    },
    {
      name: 'Noé',
      role: 'Lead Development',
      image: '/media/Team/Noe normal.jpg',
      hoverImage: '/media/Team/Noe Lupe.jpg',
      hoverColor: '#fe4a2c',
    },
    {
      name: 'Sara',
      role: 'Lead Admin & Finance',
      image: '/media/Team/Sara normal.jpg',
      hoverImage: '/media/Team/Sara Lupe.jpg',
      hoverColor: '#ffc32e',
    },
    {
      name: 'Marco',
      role: 'Lead Marketing',
      image: '/media/Team/Marco normal.jpg',
      hoverImage: '/media/Team/Marco Lupe.jpg',
      hoverColor: '#00c4ff',
    },
  ]
